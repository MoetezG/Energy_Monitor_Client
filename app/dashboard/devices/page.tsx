          ...
          <div className="flex justify-between items-center h-18 py-2">
            <div className="flex items-center">
              <Link href="/dashboard" className="flex items-center group">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Configure and manage SCADA devices</p>
                </div>
              </Link>
            </div>
            ...
            <div className="flex items-center space-x-6">
              <div className="hidden md:flex items-center bg-blue-50 px-3 py-2 rounded-full">
                ...
                <span className="text-sm font-medium text-blue-700">Configuration Mode</span>
              </div>
      ...
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto mb-6">
            Discover, configure, and manage your SCADA devices. Select devices and their variables to enable real-time monitoring.
          </p>
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg p-6 border border-gray-100">
            ...
            <ol className="space-y-3 text-gray-700">
              <li className="flex items-start">
                <span className="flex items-center justify-center w-6 h-6 bg-blue-100 text-blue-600 text-sm font-semibold rounded-full mr-3 flex-shrink-0">1</span>
                <span>Select devices from the &quot;Available SCADA Devices&quot; section</span>
              </li>
              <li className="flex items-start">
                <span className="flex items-center justify-center w-6 h-6 bg-blue-100 text-blue-600 text-sm font-semibold rounded-full mr-3 flex-shrink-0">2</span>
                <span>Choose specific variables you want to monitor for each device</span>
              </li>
              <li className="flex items-start">
                <span className="flex items-center justify-center w-6 h-6 bg-blue-100 text-blue-600 text-sm font-semibold rounded-full mr-3 flex-shrink-0">3</span>
                <span>Review your selection in the summary section</span>
              </li>
              <li className="flex items-start">
                <span className="flex items-center justify-center w-6 h-6 bg-blue-100 text-blue-600 text-sm font-semibold rounded-full mr-3 flex-shrink-0">4</span>
                <span>Click &quot;Save to Database&quot; to store configuration</span>
              </li>
            </ol>
          </div>
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg p-6 border border-gray-100">
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div>
                  <div className="font-semibold text-green-900">Monitor Devices</div>
                  <div className="text-sm text-green-700">View real-time values and data</div>
                </div>
              ...
              <div className="p-3 bg-gray-50 rounded-xl">
                <div className="text-sm text-gray-600">
                  <strong>Tip:</strong> Once devices are saved, you can access real-time monitoring, configure alerts, and view historical data trends.
                </div>
              </div>
            </div>
          </div>
