  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div
          className="absolute w-[400px] h-[400px] animate-[chaos-move_40s_ease-in-out_infinite] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-40"
          style={{
            background:
              "linear-gradient(135deg, rgba(59, 130, 246, 0.8) 0%, rgba(147, 51, 234, 0.6) 30%, rgba(239, 68, 68, 0.8) 60%, rgba(59, 130, 246, 0.5) 100%)",
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl border border-white/20 p-8   animate-[pulse-glow_4s_ease-in-out_infinite]">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-blue-200 text-sm">Smart Energy Management</p>
          </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-blue-300">
            © 2025 Optiwatt Solutions & Systems. All rights reserved.
          </p>
        </div>
      </div>
    </div>
