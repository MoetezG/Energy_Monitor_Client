    ...
    try {
      ...
      for (const device of selectedDevices) {
        ...
        for (const v of selectedVars) {
          const varCode = v.id.split('.').slice(1).join('.') || v.id;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Available SCADA Devices</h3>
                ...
                >
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">SCADA Device</p>
                    </div>
      ...
      {selectedDevices.length > 0 && (
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-gray-900">Selected Devices & Variables</h3>
              ...
              <div key={device.id} className="border border-gray-200 rounded-lg p-4">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-sm text-blue-600">
                    {getSelectedVariablesForDevice(device.id).length} variables selected
                  </span>
                </div>
                    ...
                    {device.variables.map(variable => (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-xs text-gray-500">Value: {String(variable.value)}</p>
                        </div>
                      </label>
                    ))}
                  </div>
